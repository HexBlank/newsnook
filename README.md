...
本软件以 [Apache License 2.0](./LICENSE) 开源发布。
...
从源码构建 Web / Android、签名、CI 发版与调试说明，见 [`docs/android-build.md`](./docs/android-build.md)。
...
5. **软件许可**  
   NewsNook 源代码与本仓库中的软件以 [Apache License 2.0](./LICENSE) 授权。你可以在遵守该许可的前提下使用、修改与再分发；版权归属与署名见 [`NOTICE`](./NOTICE)。第三方新闻正文、商标与媒体名称的权利归属不受本许可影响，仍适用上文第 1–3 条。问题反馈请通过 [Issue](https://github.com/t59688/newsnook/issues) 提出。
