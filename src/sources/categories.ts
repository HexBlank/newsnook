...
export const CATEGORIES: NewsCategory[] = [
  ...
  },
  {
    ...
    label: '热点',
    short: '热点',
    caption: '网易头条 · BBC · SCMP · NPR',
    sourceIds: ['netease', 'bbc-zh', 'scmp-china', 'npr'],
  },
  {
    id: 'ent',
    label: '娱乐',
  ...
  },
  {
    ...
    label: '商业',
    short: '商业',
    caption: '网易商业 · 晚点 · 甲子光年 · 36氪 · 虎嗅 · 钛媒体 · TechCrunch · Google 商业',
    sourceIds: [
      'netease-biz',
      'latepost',
      'jazzyear',
  ...
  },
  {
    ...
    label: '国际',
    short: '国际',
    caption: 'BBC · DW · SCMP · NPR · Guardian · France24 · Al Jazeera · Google 全球',
    sourceIds: [
      'bbc-zh',
      'bbc-zh-world',
      'bbc-world',
  ...
  solo('zhihu', '知乎日报', 'zhihu-daily', '知乎日报精选（直连官方列表接口）'),
  {
    ...
    label: '科技深度',
    short: '深度',
    caption: 'Ars · MIT TR · The Verge · 爱范儿 · InfoQ · 知识分子 · WIRED · HN',
    sourceIds: [
      'arstechnica',
      'mittr',
      'verge',
