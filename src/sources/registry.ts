...
export const SOURCES: NewsSource[] = [
  ...
  neteaseChannel('netease-sports', '体育', 'T1348649079062'),
  neteaseChannel('netease-game', '游戏', 'T1348654151579'),
  neteaseChannel('netease-health', '健康', 'T1414389941036'),
  neteaseChannel('netease-nba', 'NBA', 'T1348649145984'),
  neteaseChannel('netease-biz', '商业', 'T1348648756099'),
  neteaseChannel('netease-edu', '教育', 'T1348654225495'),
  neteaseChannel('netease-fun', '轻松一刻', 'T1350383429665', {
    group: 'special',
    label: '轻松一刻',
  }),
  neteaseChannel('netease-antique', '古玩', 'T1441074311424'),
  neteaseChannel('netease-gov', '政务', 'T1414142214384'),
