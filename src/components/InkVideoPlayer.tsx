...
export function InkVideoPlayer({ src, poster, title }: Props) {
  ...
  return (
    ...
    >
      <div className={`relative bg-black ${fullscreen ? 'h-full min-h-[240px]' : 'aspect-video'}`}>
        <video
          ref={videoRef}
          className="ink-video-player-media h-full w-full object-contain"
          poster={poster}
          playsInline
          preload="metadata"
          controls={false}
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="rounded-full p-1.5 text-paper"
              >
                {playing ? (
              ...
              <span className="min-w-[72px] font-mono text-[10px] tracking-wide text-paper/85">
              ...
              <div className="relative">
                <button
                  ...
                  className="rounded-full px-2 py-1 font-mono text-[11px] tracking-wide text-paper"
                >
                  {rate}x
                </button>
                {rateMenuOpen && (
